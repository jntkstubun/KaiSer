 ...
 * Handles Master Creator Login, Subscription Expirations, Admin Quotas, Extra Admin Approvals, Broadcasts, and Interactive Status Toggles
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  window.changeWarungStatusDirect = (warungId, newStatus) => {
    ...
    if (res.success) {
      showToast(`🔄 Status ${res.warung.warungName} diubah ke ${newStatus}!`, 'info');
      renderDashboard();
    }
  };
